...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    if (!email || !password) return Alert.alert('Vul alles in!');
    try {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput style={styles.input} placeholder="Password" placeholderTextColor="#ccc" value={password} onChangeText={setPassword} secureTextEntry={!showPassword} />
...
const styles = StyleSheet.create({
  ...
  title: { color: '#F39C12', fontSize: 28, fontWeight: 'bold', marginBottom: 40, textAlign: 'center' },
